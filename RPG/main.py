...
#creates function for drawing text
...
class Fighter():
    ...
    def idle(self):
        # set variables to idle animations
        self.action = 0
        self.frame_index = 0
        self.update_time = pygame.time.get_ticks()
    ...
    def attack(self,target):
        ...
        #set variables to attack animations
...
bandit2_health_bar = HealthBar(550,screen_height - bottom_panel + 100,bandit1.hp,bandit1.max_hp)


#create buttons
potion_button = button.Button(screen,100 ,screen_height - bottom_panel + 70 , potion_img,64,64)
restart_button = button.Button(screen,340 ,120 + 70 , restart_img,120,30)
run = True
while run:
    clock.tick(fps)
    ...
    if game_over == 0:
        ...
        if knight.alive == True:
            if current_fighter == 1:
                ...
                if action_cooldown >= action_wait_time:
                    ...
                    if potion == True:
                        if knight.potions > 0:
                            #check if would potion heal beyond max health
        ...
        #if all fighters have had a turn,the reset
